...
/**
* User Model Utility functions module for the Kaizenify app
*/
//==============================================================================
/**
* Module dependencies
...
/*function findUser(req, res) {
  return UserModel.find({name: req.params.name}, 'name email',
    function (err, user) {
...
//find just one user
function findUser(req, res) {
  return UserModel.findOne({email: req.params.email}, 'name email',
    function (err, user) {
